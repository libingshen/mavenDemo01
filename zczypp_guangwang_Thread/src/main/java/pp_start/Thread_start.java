...
public class Thread_start {
	...
	public static void main(String[] args) {
		//创建 文件夹 F:/GWlog
		String logDirPath = "F:"+File.separator+"GWlog";
    	...
    	logDir.mkdirs();
		//创建文件夹 F:/GWlog/光网站址
		String logZhanzhiStr = "F:"+File.separator+"GWlog"+File.separator+"光网站址";
    	...
    	logZhanzhi.mkdirs();
    	//创建文件夹 F:/GWlog/光网索引
		String logIndexStr = "F:"+File.separator+"GWlog"+File.separator+"光网索引";
    	...
    	logIndex.mkdirs();
    	//创建文件夹 F:/GWlog/光网匹配
		String logPPStr = "F:"+File.separator+"GWlog"+File.separator+"光网匹配";
